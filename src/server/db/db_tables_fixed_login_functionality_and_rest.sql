...
CREATE TABLE `bsm_people` (
  ...
  `longtidue` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `bsm_people` */

insert  into `bsm_people`(`id`,`firstname`,`lastname`,`middlename`,`age`,`gender`,`cell_number`,`person_status`,`photo`,`status`,`created_at`,`updated_at`,`latitude`,`longtidue`) values (1,'Dexcleir','Rañin','L.',22,'male','09351840596','1','dex_101.jpg',1,'0000-00-00 00:00:00','0000-00-00 00:00:00','',''),(2,'Alben','Sandot','B.',22,'male','09351840596','1','alben_101.jpg',1,'0000-00-00 00:00:00','0000-00-00 00:00:00','',''),(3,'Leivince','Marte','B.',23,'male','09351840596','1','vince_101.jpg',1,'0000-00-00 00:00:00','0000-00-00 00:00:00','',''),(4,'Rannel John','Catolpos','B.',22,'male','09351840596','1','ran_101.jpg',1,'0000-00-00 00:00:00','0000-00-00 00:00:00','',''),(5,'asdfasdf','asdfasdf','sadfasdf',1,'sdafdsaf','sadfdasf','sadfasdf','dsaf',0,'2013-11-24 00:35:21','2013-11-24 00:35:21','asdfadsf','sadfasdf'),(6,NULL,NULL,NULL,0,NULL,'',NULL,NULL,1,'2013-11-24 03:34:35','2013-11-24 03:34:35','','');
...
insert  into `bsm_users`(`id`,`username`,`password`,`type`,`status`,`created_at`,`updated_at`,`email`) values (1,'baizhebun','$2y$08$CGCAC6zCepmirA1ke8hGbuWPppcc4QBeSztZlV22Qyapwxjv7yYHy','mun_admin',1,'0000-00-00 00:00:00','2013-11-24 00:13:20','dexcleir'),(2,'ran','$2y$08$CGCAC6zCepmirA1ke8hGbuWPppcc4QBeSztZlV22Qyapwxjv7yYHy','mun_admin',1,'0000-00-00 00:00:00','2013-11-24 00:13:27','ran'),(8,'yeah','$2y$08$LIFXOBJRarS6kPyhj/9Kd.fSdS7UPfwBo6ULgZ5CdtQbxmC.zrbU6','mun_admin',1,'2013-11-24 02:34:17','2013-11-24 02:34:17',NULL);
