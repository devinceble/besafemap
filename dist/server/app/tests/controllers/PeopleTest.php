...
class PeopleTest extends TestCase {
	...
	public function testStore()
	{
		...
		$this->validate(true);
		$this->call('POST', 'people');

		$this->assertRedirectedToRoute('people.index');
	}
	...
	public function testUpdate()
	{
		...
		$this->validate(true);
		$this->call('PATCH', 'people/1');

		$this->assertRedirectedTo('people/1');
	}
	...
	public function testUpdateFails()
	{
		...
		$this->assertRedirectedTo('people/1/edit');
		$this->assertSessionHasErrors();
		$this->assertSessionHas('message');
	}
